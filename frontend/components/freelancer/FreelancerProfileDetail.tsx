                            ...
                            <div className="w-full flex-1">
                                ...
                                <div className="flex justify-center divide-x divide-zinc-200 font-mono md:justify-start">
                                    <div className="flex flex-col px-5 text-center first:pl-0 md:text-left">
                                        ...
                                        <span className="mt-1 text-[9px] uppercase tracking-widest text-zinc-400">
                                            Posts
                                        </span>
                                    </div>
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        <div className="flex flex-col items-center p-7 text-center">
                                            <h3 className="mb-4 flex min-h-[2.5rem] items-center justify-center text-base font-black leading-tight text-zinc-900 transition-colors line-clamp-2 group-hover:text-[#7A4FFF]">
                                                {p.title}
                                            </h3>
