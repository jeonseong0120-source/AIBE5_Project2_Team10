                ...
                <aside className="space-y-4 lg:sticky lg:top-24 lg:self-start">
                    ...
                    {!isEditingProfile && (
                        <div className="bg-white rounded-2xl p-6 border border-zinc-200 shadow-sm space-y-3">
                            <p className="text-[10px] font-black font-mono uppercase text-zinc-400 tracking-widest">프로필 정보</p>
                            ...
                            <div className="flex items-center gap-2 text-sm text-zinc-600">
                                <Activity size={14} className="text-zinc-400 flex-shrink-0" />
                                <span className="font-bold">{profile?.workStyle || '방식 미설정'}</span>
                            </div>
                            {profile?.introduction && (
                                <p className="text-xs text-zinc-500 leading-relaxed pt-2 border-t border-zinc-100">{profile.introduction}</p>
                            )}
                    ...
                    {isEditingProfile && (
                        <div className="bg-white rounded-2xl p-6 border border-zinc-200 shadow-sm space-y-4">
                            <p className="text-[10px] font-black font-mono uppercase text-zinc-400 tracking-widest">프로필 편집</p>

                            <div className="space-y-2">
                                <label className="text-[10px] font-mono tracking-widest uppercase font-black text-zinc-400">활동 지역</label>
                                <select value={editProfileData.location} onChange={e => setEditProfileData({ ...editProfileData, location: e.target.value })} className="w-full bg-zinc-50 p-3 rounded-xl border border-zinc-200 outline-none focus:border-[#7A4FFF] text-sm font-bold">
                            ...
                            <div className="space-y-2">
                                ...
                                <input
                                    ...
                                    className="w-full bg-zinc-50 p-3 rounded-xl border border-zinc-200 outline-none focus:border-[#7A4FFF] text-sm font-bold"
                            ...
                            <div className="space-y-2">
                                ...
                                <select value={editProfileData.workStyle} onChange={e => setEditProfileData({ ...editProfileData, workStyle: e.target.value })} className="w-full bg-zinc-50 p-3 rounded-xl border border-zinc-200 outline-none focus:border-[#7A4FFF] text-sm font-bold">
                            ...
                            <div className="space-y-2">
                                ...
                                <textarea rows={3} value={editProfileData.introduction} onChange={e => setEditProfileData({ ...editProfileData, introduction: e.target.value })} className="w-full bg-zinc-50 p-3 rounded-xl border border-zinc-200 outline-none focus:border-[#7A4FFF] text-sm font-bold transition-colors resize-none" placeholder="자신의 강점을 어필해주세요." />
                            </div>

                            {/* 스킬 편집 */}
                            <div className="space-y-2 border-t border-zinc-100 pt-4">
                                <p className="text-[10px] font-black font-mono uppercase text-zinc-400">보유 기술</p>
                                ...
                                <input className="w-full px-3 py-2 rounded-xl bg-zinc-50 border border-zinc-200 outline-none text-xs font-bold focus:border-[#FF7D00]" placeholder="스킬 검색..." value={skillSearchQuery} onChange={e => setSkillSearchQuery(e.target.value)} />
                    ...
                    <div className="bg-white rounded-2xl p-2 border border-zinc-200 shadow-sm">
                        {!isEditingProfile ? (
                            <>
                                ...
                                <button onClick={() => setIsEditingProfile(true)} className="w-full flex items-center gap-3 p-4 hover:bg-zinc-50 rounded-xl transition text-sm font-bold text-zinc-700">
                            ...
                            <div className="flex flex-col gap-2 p-2">
                                {validationError && (
                                    <div className="text-[10px] text-red-500 font-bold bg-red-50 px-3 py-1.5 rounded-lg border border-red-100">
                                        🚨 {validationError}
                                    </div>
                                )}
                        ...
                        <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: 30 }} className="bg-white rounded-3xl w-full max-w-4xl max-h-[95vh] overflow-y-auto no-scrollbar shadow-2xl relative flex flex-col md:flex-row">
                            ...
                            <div className="w-full md:w-[50%] p-8 md:p-10 flex flex-col">
                                <div className="flex-1">
                                    <h2 className="text-2xl font-black text-zinc-900 tracking-tight leading-tight mb-4">{selectedPortfolio.title}</h2>
                                        ...
                                        <div className="mb-8">
                                            ...
                                            <div className="flex flex-wrap gap-2">
                                                {selectedPortfolio.skills.map((s: any) => (
                                                    <span key={s.id} className="px-3 py-1.5 bg-[#7A4FFF]/5 text-[#7A4FFF] border border-[#7A4FFF]/20 rounded-lg text-xs font-bold">#{s.name}</span>
                                                ))}
                                            </div>
                                        </div>
                                    )}
